        ...
        <div className={styles.Wrapper}>
            ...
            <div className={styles.Mid}>
                ...
                <div className={styles.DetailedIntro}>
                    FM Studio는 Four Man Studio의 약어로, 현재 HQRoutine을
                    개발중인 팀입니다. 총 4인 구성에 많은 것들을 시도해보고 있는
                    팀으로 프로젝트의 미래가 창창하다고 볼 수 있습니다. 이
                    이후에 읽고계신 글은 스크롤을 넘기기 위해서 하고 있는 것으로
                    생각보다 좋은 결과를 낼 수 있을 것으로 보입니다 과연 어떻게
                    끝날 지 궁금한 이 순간에 저는 지금부터 글을 늘려보도록
                    하겠습니다 늘려보도록 하겠습니다늘려보도록
                    하겠습니다늘려보도록 하겠습니다 늘려보도록
                    하겠습니다늘려보도록 하겠습니다늘려보도록
                    하겠습니다늘려보도록 하겠습니다
                </div>
            </div>
